---
title: 'Supplemental file 2: Prognostic model to identify and quantify risk factors for mortality among hospitalised patients with COVID-19 in the USA'
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: yes
